...
from game import AgentEnv, EpisodeReplayEnv, Game, PlayerSaveEnv
...
def main(cfg: DictConfig):
    ...
    assert cfg.mode in ('episode_replay', 'agent_in_env', 'agent_in_world_model', 'play_in_world_model', 
                        'world_model_in_env', 'player_save_env')
    ...
    if cfg.mode == 'episode_replay':
        ...
        elif cfg.mode == 'player_save_env':
            env = PlayerSaveEnv(agent, test_env, cfg.env.keymap, do_reconstruction=False)
            keymap = cfg.env.keymap
